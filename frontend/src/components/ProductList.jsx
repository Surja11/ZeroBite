...
// // function ProductList({onProductClick,products}) {
...
//   const { products, handleSpecific } = useContext(ProductsContext);

//   return (
//     <div>
//       <h1 className="border-t border-x border-gray-100 text-gray-500 outline-0 p-4 text-2xl">
//         Products
//       </h1>
//       <div className="min-h-screen border border-gray-100 shadow-md">
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 bg-gray-100 gap-8 p-6">
...
//               onClick={() => handleSpecific(item.id)}
//             >
//               <img
//                 src={`http://127.0.0.1:8000${item.image}`}
//                 alt={item.name}
