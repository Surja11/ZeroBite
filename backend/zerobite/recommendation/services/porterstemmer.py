...
if __name__ == "__main__":
    ...
    print(stemmer.stem("butter"))
    print(stemmer.stem("creamy"))
    print(stemmer.stem("dairy"))
    print(stemmer.stem("spread"))
    print(stemmer.stem("cheese"))
    print(stemmer.stem("block"))
    print(stemmer.stem("orange"))
    print(stemmer.stem("sweet"))
    print(stemmer.stem("citrus"))
    print(stemmer.stem("fruit"))
